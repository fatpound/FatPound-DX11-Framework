...
namespace fatpound::win32::dx11
{
    Graphics::Graphics(HWND hWnd)
    {
        ...
        {
            MessageBox(nullptr, L"Non-STD Exception was thrown inside Graphics CTOR!", L"Graphics Error", MB_OK | MB_ICONERROR);
    ...
    void Graphics::EndFrame()
    {
        ...
        {
            MessageBox(nullptr, L"Non-STD Exception was thrown inside EndFrame()!", L"Graphics Error", MB_OK | MB_ICONERROR);
